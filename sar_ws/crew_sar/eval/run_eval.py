...
_FAULT_STATE = {
    "iris_unavailable": {"iris_busy": True, "tb3_busy": False},
    "tb3_unavailable": {"iris_busy": False, "tb3_busy": True},
}

# Perception faults injected inside the mock Iris adapter; they surface at
# the rover's dispatch through the state interface (no_target_fix).
_MOCK_FAULTS = ("nan_transmission", "missed_detection")
...
def main():
    ...
    if args.latex:
        print("\n% --- paste into tab:sim-comparison (planning-layer rows) ---")
